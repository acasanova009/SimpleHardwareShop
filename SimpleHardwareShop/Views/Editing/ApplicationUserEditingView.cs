...
public static class ApplicationUserEditingView
{
    ...
    public static void Menu(HardwareShopContext db,int userId)
	{
        ...
        var applicationUser = applicationUserController.Index(userId);
            ...
            try
            {
                ...
                switch (opcion)
                {
                    case 1:
                        ...
                        applicationUserController.Update(applicationUser);
